  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8 overflow-y-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <Link
  href="/signup"
  className="inline-block bg-purple-700 hover:bg-purple-700 text-white text-lg px-8 py-3 rounded-full shadow-lg transition-transform transform hover:scale-105"
>
